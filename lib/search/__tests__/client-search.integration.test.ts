...
describe("ClientSearchIndex Integration Tests", () => {
      ...
      articles: [
        {
          ...
          readingTime: 5,
          content:
            "这是一个基于 Next.js 构建的静态博客系统，主要目的是为了记录和整理我的技术学习笔记。作为一名开发者，在日常工作和学习中会接触到各种各样的技术知识点。",
        },
        {
        ...
        },
        {
          ...
          readingTime: 8,
          content:
            "TypeScript 是 JavaScript 的超集，添加了类型系统和其他特性。本文介绍 TypeScript 的最佳实践。",
        },
        {
          ...
          readingTime: 12,
          content:
            "Python 是数据分析领域最流行的编程语言之一。本文介绍如何使用 Python 进行数据分析。",
        },
      ],
      indexed: {
        // English tokens
  ...
  describe("Search Performance", () => {
    it("should handle searches with many tokens efficiently", async () => {
      const longQuery =
        "react hooks guide typescript best practices python data analysis blog 技术 博客 前端 开发";
